...
class Hitbox{
	...
	isInsideCheckpoint(Xmin, Ymin, Xmax, Ymax, object){
	...
	isOutsideGamescreen(boundaryX1, boundaryY1, boundaryX2, boundaryY2, object, dx=0,dy=0){
	...
	intersects(rectA,centerX,centerY){
	...
	isHit(player, bullet){//checks if a player has been hit by a bullet 
		...
		return this.intersects(playerRect, bullet.centerX, bullet.centerY) //doPolygonsIntersect(playerRect,bulletRect)
	}
